...
CREATE TABLE `promotion_has_books` (
  ...
  `Book_ISBN` varchar(14) NOT NULL,
  PRIMARY KEY (`Promotion_idPromotion`,`Book_ISBN`),
  KEY `fk_Promotion_has_Books_Books1_idx` (`Book_ISBN`),
  KEY `fk_Promotion_has_Books_Promotion1_idx` (`Promotion_idPromotion`),
  CONSTRAINT `fk_Promotion_has_Books_Books1` FOREIGN KEY (`Book_ISBN`) REFERENCES `book` (`ISBN`),
  CONSTRAINT `fk_Promotion_has_Books_Promotion1` FOREIGN KEY (`Promotion_idPromotion`) REFERENCES `promotion` (`idPromotion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-12 21:18:44
