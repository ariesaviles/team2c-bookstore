...
INSERT INTO `address` VALUES (6,'432','432','432',432,1);
...
INSERT INTO `card` VALUES (7,'Visa','2021-06-01',1,'Calvin','$2a$10$zIv8ttNOh4sVzb63TbvJXe1y54Qjk.hF64dA1Y46339.UhBO.D5Jy','$2a$10$BUuVMT9H1AF2qU5DxysQsua2bBF.CmT3tWmzjg2mwS89ATfGrTYLe'),(14,'Visa','2021-07-01',1,'Calvin Butson','$2a$10$dKjMTrm5WozEmHEAWTHeoeCks7P69Vs0hRVSO/DuzrU21u1NTFr0y','$2a$10$wNRD2iib4pouWaE2Sp.nu.5/rO86uSqpaai13COZ8kze9s5jaLuzu');
...
INSERT INTO `order_has_books` VALUES (22,25,1),(22,26,1),(23,25,1),(24,25,1),(25,24,1);
...
CREATE TABLE `order_table` (
  ...
  KEY `FKev742wwwpg2giy8wn41dy9yv` (`idcard`),
  ...
  CONSTRAINT `FK8lbsi1p36flew9gekdbb1sd4w` FOREIGN KEY (`card_idcard`) REFERENCES `card` (`idCard`),
  CONSTRAINT `FKev742wwwpg2giy8wn41dy9yv` FOREIGN KEY (`idcard`) REFERENCES `card` (`idCard`),
...
INSERT INTO `order_table` VALUES (22,'20210429',0,6,7,NULL,1,NULL),(23,'20210429',0,6,7,NULL,1,NULL),(24,'20210429',0,6,7,NULL,1,NULL),(25,'20210429',0,6,7,NULL,1,NULL);
...
-- Dump completed on 2021-04-29  9:42:14
